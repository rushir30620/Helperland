...
export class ServiceProviderController{
                ...
                const transporter = nodemailer.createTransport({
                    ...
                    const mailOptions = {
                        ...
                        html: `<h4>Kindly click on the below given link to activate your account</h2>
                                <p>${process.env.URL}/verify/helper/${token}`
                    };
    ...
    public loginServiceProvider = async(req: Request, res: Response): Promise<Response> => {
        return this.serviceProviderService.loginServiceProvider(req.body.email)
