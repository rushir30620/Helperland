...
var ServiceProviderController = /** @class */ (function () {
    function ServiceProviderController(serviceProviderService) {
        ...
        this.createServiceProvider = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _a.password = _b.sent();
                        return [2 /*return*/, this.serviceProviderService
        ...
        this.loginServiceProvider = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, this.serviceProviderService.loginServiceProvider(req.body.email)
